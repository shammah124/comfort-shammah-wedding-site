...
# docker build -t wedding_invitation .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name wedding_invitation wedding_invitation
...
# Start the Rails server directly (Puma respects $PORT)
EXPOSE 80
